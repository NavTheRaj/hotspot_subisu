...
<div class="p-4">
			...
			<div class="md-form">
				...
				<input type="text" id="" name="name" class="form-control white-text" required="required">
			...
			<div class="md-form">
				...
				<input type="email" id="" name="email" class="form-control white-text" required="required">
			...
			<div class="md-form">
				...
				<input type="text" id="" name="phone_number" class="form-control white-text"  required="required">
